  ...
  return (
    <div className="space-y-12 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-px bg-neutral-200">
        <Card className="border-0 rounded-none bg-white hover:bg-neutral-50 transition-colors cursor-pointer group">
          <CardContent className="p-10">
            <div className="text-sm uppercase tracking-wider text-neutral-500 mb-4 font-medium">Total</div>
            <div className="text-6xl font-light text-neutral-900 mb-2">{todayJobs.length}</div>
        ...
        <Card className="border-0 rounded-none bg-white hover:bg-neutral-50 transition-colors cursor-pointer group">
          <CardContent className="p-10">
            <div className="text-sm uppercase tracking-wider text-neutral-500 mb-4 font-medium">Done</div>
            <div className="text-6xl font-light text-emerald-800 mb-2">
      ...
      <Link href="/measurements/new">
        <Button
          size="lg"
          className="w-full h-24 text-lg bg-neutral-900 hover:bg-neutral-800 text-white border-0 font-medium tracking-wide uppercase transition-all duration-300 hover:shadow-2xl"
        >
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <h2 className="text-3xl font-light text-neutral-900">Today's Schedule</h2>
        ...
        <div className="space-y-px bg-neutral-200">
          {todayJobs.map((job) => (
            <div
              key={job.id}
              className="bg-white p-10 hover:bg-neutral-50 transition-all duration-300 cursor-pointer group"
            >
              <div className="flex items-center gap-10">
                {/* Elegant Time */}
                <div className="text-center min-w-[100px]">
                  <div className="text-4xl font-light text-neutral-900 mb-1">
                    {job.time.split(':')[0]}
                  </div>
                ...
                <div className="w-px h-20 bg-neutral-200"></div>

                {/* Job Details */}
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-3">
                    <h3 className="text-2xl font-light text-neutral-900">{job.client}</h3>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <h2 className="text-3xl font-light text-neutral-900">Recent Measurements</h2>
          <div className="h-px flex-1 bg-gradient-to-r from-neutral-200 to-transparent"></div>
        ...
        <div className="space-y-px bg-neutral-200">
          {[
            ...
            <div key={i} className="bg-white p-8 hover:bg-neutral-50 transition-colors cursor-pointer group flex items-center justify-between">
              <div className="flex items-center gap-8">
                <div className="w-16 h-16 bg-neutral-900 text-white rounded-none flex items-center justify-center">
                  <span className="text-2xl font-light">{item.rooms}</span>
                </div>
                <div>
                  <p className="text-lg font-light text-neutral-900 mb-1">{item.client}</p>
                  <p className="text-sm text-neutral-500">{item.area}</p>
                </div>
              </div>
