    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    <Label htmlFor="assignedStaff" className="text-base">Assigned Measurer</Label>
                    <Input
                        id="assignedStaff"
                        placeholder="John Doe"
                        value={clientDetails.assignedStaff || "John Doe"}
                        onChange={(e) => setClientDetails({ ...clientDetails, assignedStaff: e.target.value })}
                        className="h-12 text-base"
                    />
                </div>
            </div>
