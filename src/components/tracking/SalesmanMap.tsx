...
export interface MapJobMarkerCardData {
  id: string;
  jobId?: string;
  customerName?: string;
  client?: string;
...
export interface SalesmanMapProps {
  fitters: Fitter[];
    ...
    <div className="relative h-full w-full overflow-hidden bg-slate-950 rounded-2xl border border-slate-800 shadow-xl flex">
      ...
      <div className="flex-1 h-full w-full relative z-0">
        <Map
          ...
          defaultZoom={11}
          mapId="salesman_assignments_map_v1"
          ...
          {[...scheduledJobs, ...unassignedJobs].map((job) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="relative w-8 h-8 rounded-lg bg-amber-500 border-2 border-white shadow-lg flex items-center justify-center text-white font-bold text-[11px]">
              ...
              <div className="p-2 text-slate-900 font-sans min-w-[200px] max-w-[280px] space-y-1.5">
                  ...
                  <div>
                    ...
                    {selectedInfoWindow.data.phoneNumber && (
                      <p className="text-xs text-slate-600 flex items-center gap-1">
                        ...
                        <a href={`tel:${selectedInfoWindow.data.phoneNumber}`} className="text-blue-600 hover:underline">
                          {selectedInfoWindow.data.phoneNumber}
                        </a>
                      </p>
                    )}
                ...
                {selectedInfoWindow.type === "job" && selectedInfoWindow.data && (
                  <div>
                    <div className="flex items-center justify-between border-b border-slate-200 pb-1 mb-1">
                      <span className="font-bold text-xs text-slate-900">
                        {selectedInfoWindow.data.customerName || selectedInfoWindow.data.client || "Job"}
                      </span>
                      <span className="text-[9px] font-mono font-bold text-amber-700 bg-amber-50 px-1 py-0.2 rounded">
      ...
      {/* ── COLLAPSIBLE SALESMEN STATUS PANEL ── */}
      {!hideStatusPanel && (
        <div
          className={cn(
              ...
              <div className="p-2 border-b border-slate-800">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-8 pl-8 pr-2 text-xs bg-slate-950 border border-slate-800 rounded-lg text-white placeholder:text-slate-500 focus:outline-none focus:border-blue-500"
                  />
                </div>
              </div>
...
export default function SalesmanMap(props: SalesmanMapProps) {
  return (
    <GoogleMapsProvider fallbackHeight="100%">
      <SalesmanMapInner {...props} />
    </GoogleMapsProvider>
  );
}
